...
def executar_analise_regiao3():
    ...
    def extrair_respostas_regiao_3(regiao_binarizada):
        respostas = []
        for linha in range(25):  # Ajuste para 5 linhas
    ...
    imagem_regiao3 = cv2.imread(relative_path.resource_path('regiao_enem/regiao_3.jpg'))
    ...
    for i, resposta in enumerate(respostas_regiao3):
        print(f'Questão {i+1}: {resposta}')


# Chamada da função principal
if __name__ == "__main__":
    executar_analise_regiao3()
